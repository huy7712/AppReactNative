...
function Chartnhakinh2() {
    ...
    function fetchDataNPK() {
        fetch('http://192.168.0.100:1234/api/npk_rs485Active')
    ...
    useEffect(() => {
        fetch('http://192.168.0.100:1234/api/npk_rs485Start')
            .then(response => response.json())
            .then(data => {
                data.forEach((item) => {
                    let localTime = moment.utc(item.time).utcOffset("+07:00").format("HH:mm:ss");
    ...
    function fetchData() {
        fetch('http://192.168.0.100:1234/api/lightI2C2Active')
            .then(response => response.json())
            .then(json => {
                const data = json; // Lưu trữ dữ liệu vào biến trung gian
    ...
    useEffect(() => {
        fetch('http://192.168.0.100:1234/api/lightI2C2Start')
            .then(response => response.json())
            .then(data => {
                data.forEach((item) => {
                    let localTime = moment.utc(item.time).utcOffset("+07:00").format("HH:mm:ss");
    ...
    function fetchDataI2C() {
        fetch('http://192.168.0.100:1234/api/temHumI2C2Active')
            .then(response => response.json())
            .then(json => {
                const data = json; // Lưu trữ dữ liệu vào biến trung gian
    ...
    useEffect(() => {
        fetch('http://192.168.0.100:1234/api/temHumI2C2Start')
            .then(response => response.json())
            .then(data => {
                data.forEach((item) => {
                    let localTime = moment.utc(item.time).utcOffset("+07:00").format("HH:mm:ss");
    ...
    function fetchDataph() {
        fetch('http://192.168.0.100:1234/api/ph_rs485Active')
            .then(response => response.json())
            .then(json => {
                const data = json; // Lưu trữ dữ liệu vào biến trung gian
    ...
    useEffect(() => {
        fetch('http://192.168.0.100:1234/api/ph_rs485Start')
            .then(response => response.json())
            .then(data => {
                data.forEach((item) => {
                    let localTime = moment.utc(item.time).utcOffset("+07:00").format("HH:mm:ss");
    ...
    function fetchDataadc() {
        fetch('http://192.168.0.100:1234/api/hum_rs485Active')
            .then(response => response.json())
            .then(json => {
                const data = json; // Lưu trữ dữ liệu vào biến trung gian
    ...
    useEffect(() => {
        fetch('http://192.168.0.100:1234/api/hum_rs485Start')
            .then(response => response.json())
            .then(data => {
                data.forEach((item) => {
                    let localTime = moment.utc(item.time).utcOffset("+07:00").format("HH:mm:ss");
